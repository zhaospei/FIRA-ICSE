...
def process():
    ...
    difftokens = json.load(open('../data4CopynetV3/difftokenV12.json'))
    diffmarks = json.load(open('../data4CopynetV3/diffmarkV12.json'))
    # difftokens = difftokens[:100]
    # diffmarks = diffmarks[:100]
    # difftokens = json.load(open('../CMGData/difftoken.json'))
    # diffmarks = json.load(open('../CMGData/diffmark.json'))
    processed_tokens = []
    processed_types = []
